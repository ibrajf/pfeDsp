...
pipeline {
    ...
    stages {
        ...
        stage('Deploy to Preprod') {
            steps {
                script {
                    def imageName = "devopsgroupe4/myapp_react-app:${appVersion}-preprod-${env.GIT_COMMIT}"
        ...
        stage('Deploy to Prod') {
            steps {
                script {
                    def imageName = "devopsgroupe4/myapp_react-app:${appVersion}-prod-${env.GIT_COMMIT}"
